...
function Signin() {
    ...
    const signinNow = (email, password) => __awaiter(this, void 0, void 0, function* () {
        setLoading(true);
        const res = yield signin(email.toLowerCase(), password);
    ...
    return (react_1.default.createElement("div", null, show && (react_1.default.createElement("div", { className: "block mx-5 md:mx-auto " },
        ...
        react_1.default.createElement("div", { className: "flex flex-col my-5  mx-5 md:w-10/12 mx-auto max-w-lg md:max-w-6xl" },
            react_1.default.createElement("nav", { onClick: (e) => navigate("/"), className: "flex justify-start  " },
            ...
            react_1.default.createElement("div", { className: "flex  items-start mx-auto" },
                ...
                react_1.default.createElement("div", { className: " flex flex-col justify-center items-center space-y-4  max-w-[320px]" },
                    react_1.default.createElement("div", { className: "flex justify-center" },
                        react_1.default.createElement("h2", { className: "text-3xl " }, "Sign in")),
                    react_1.default.createElement("div", { className: "relative mx-auto block " },
                        react_1.default.createElement("label", { className: "absolute top-2 left-5 " }, "Email Address"),
                        react_1.default.createElement("input", { value: emailValue, onChange: (e) => setEmailValue(e.target.value), className: "bg-owhite w-lg border border-dblue rounded-lg p-2 md:w-80 pt-7 pl-5", alt: "email" })),
                    react_1.default.createElement("div", { className: "relative mx-auto block" },
                        react_1.default.createElement("p", { className: "absolute top-2 left-5 " }, "Password"),
                        react_1.default.createElement("input", { value: passwordValue, onChange: (e) => setPasswordValue(e.target.value), type: "password", className: "bg-owhite w-lg border border-dblue rounded-lg p-2 md:w-80 pt-7 pl-5 ", alt: "password" })),
                    react_1.default.createElement("div", null, loading ? (react_1.default.createElement(CircularProgress_1.default, null)) : (react_1.default.createElement("button", { onClick: (e) => signinNow(emailValue, passwordValue), className: "bg-dblue text-sm py-4 px-9 md:text-lg  text-owhite rounded-lg hover:bg-lblue hover:text-dblue hover:border-2" }, "Sign in"))),
                    ...
                    react_1.default.createElement("p", null,
                        "Need an account?",
                        " ",
                        react_1.default.createElement("span", { onClick: (e) => navigate("/signup"), className: "cursor-pointer text-dblue hover:border-b hover:border-b-dblue " }, "Sign up")),
