...
export default function Newpost() {
  ...
  const previewedContent = (previewTarget: any) => {
  ...
  const contentPreviewIcon = (previewTarget: any) => {
    switch (previewTarget) {
      case "twitter":
        return twitter;
      case "facebook":
  ...
  const maxMedia = () => {
    ...
    const result = targetMedia?.map((obj: any) => {
      if (obj.type === "gif" || obj.type === "video") {
        max = true;
      }
    });
    if(typeof value.twitterCounter !== 'undefined' && value.state.value[value.twitterCounter]?.media?.length === 4) {
      max = true;
    }
  ...
  const selectImage = (uploadedFile: any, index: any) => {
    setLoading(true);
    let type: any;
  ...
  const updateContents = (type: any, reader: any, extension: any) => {
    switch (value.target) {
      case "twitter":
        dispatch({
          type: "addPicture",
  ...
  const previewPicture = (previewTarget: any) => {
    switch (previewTarget) {
      case "twitter":
  ...
  const publish = async () => {
    ...
    const facebookConnect = user.connect.find((item: any) => {
      return item.social === "facebook";
    });

    const linkedinConnect = user.connect.find((item: any) => {
  ...
  const organizeData = async () => {
    return await Promise.all(
      value.state.value.map(async (obj: any) => {
        const media = await Promise.all(
          obj.media.map(async (mediaObj: any) => {
  ...
  const removeImage = (e: any, pic: any) => {
    switch (value.previewTarget) {
      case "twitter":
        ...
        typeof value.setTwitterPicture !== 'undefined' &&  value.setTwitterPicture(
          previewPicture(value.previewTarget).filter(
            (item: any) => item.value !== pic.value
          )
        );
          ...
          <div className="flex flex-col md:w-1/2 space-y-6 space-x-6 ">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                       ...
                       typeof value.setTarget !== 'undefined' &&   value.setTarget(
                          e.target.value.split(" ")[0].toLowerCase()
                        );
                        typeof value.setPreviewTarget !== 'undefined' && value.setPreviewTarget(
                          e.target.value.split(" ")[0].toLowerCase()
                        );
                      } else {
                        typeof value.setSelect !== 'undefined' &&  value.setSelect((prev) =>
            ...
            <div className="flex flex-col space-y-2">
              ...
              >
                ...
                <p className="">
                  @{socials.find((item: any) => item.type === "twitter")?.username}
                </p>
              </div>
              <div
                className={
              ...
              >
                ...
                <p className="">
                  @{socials.find((item: any) => item.type === "facebook")?.username}
                </p>
              </div>
              <div
                className={
              ...
              >
                ...
                <p className="">
                  @{socials.find((item: any) => item.type === "instagram")?.username}
                </p>
              </div>
              <div
                className={
              ...
              >
                ...
                <p className="">
                  @{socials.find((item: any) => item.type === "linkedin")?.username}
                </p>
              </div>
            </div>
            ...
            <div className="flex-flex-col space-y-2">
              <div className=" mb-10 flex space-x-2 md:space-x-4  border border-dblue bg-dblue bg-opacity-10 items-center rounded-lg w-fit">
                ...
                >
                  <div
                    onClick={(e) => typeof value.setTarget !== 'undefined' && value.setTarget("facebook")}
                    className={
                ...
                >
                  <div
                    onClick={(e) => typeof value.setTarget !== 'undefined' && value.setTarget("twitter")}
                    className={
                ...
                >
                  <div
                    onClick={(e) => typeof value.setTarget !== 'undefined' && value.setTarget("instagram")}
                    className={
                ...
                >
                  <div
                    onClick={(e) => typeof value.setTarget !== 'undefined' && value.setTarget("linkedin")}
                    className={
            ...
            >
              <button
                onClick={(e) => typeof value.setPreview !== 'undefined' && value.setPreview(true)}
                className={
                  value.preview
                    ? "hidden"
          ...
          >
            <div className="flex-flex-col space-y-2">
              <div className="mb-10 flex space-x-2 md:space-x-4 border border-dblue w-fit bg-dblue bg-opacity-10 items-center rounded-lg">
                ...
                >
                  <div
                    onClick={(e) => typeof value.setPreviewTarget !== 'undefined' && value.setPreviewTarget("facebook")}
                    className={
                ...
                >
                  <div
                    onClick={(e) => typeof value.setPreviewTarget !== 'undefined' && value.setPreviewTarget("twitter")}
                    className={
                ...
                >
                  <div
                    onClick={(e) => typeof value.setPreviewTarget !== 'undefined' && value.setPreviewTarget("instagram")}
                    className={
                ...
                >
                  <div
                    onClick={(e) => typeof value.setPreviewTarget !== 'undefined' && value.setPreviewTarget("linkedin")}
                    className={
